...
- 当前 R0 REVIEW_REQUIRED：已用异步消息集中提交 smoke 配置确认，未收到批准；草案 `scripts/business-memory/protocol-smoke.draft.json` 不可自行改成 approved。B3 完整 runner/新 Proxy/Core/Hub 未实现，B4/B5 Memory 对照未启动。
