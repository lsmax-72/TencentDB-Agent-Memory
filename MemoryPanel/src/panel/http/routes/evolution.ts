...
const ACTIONS = new Set(['overview', 'records/list', 'records/get', 'profiles/list', 'profiles/options', 'profiles/save', 'observation/ingest', 'task/complete', 'diagnosis/request', 'diagnosis/retry', 'generation/retry', 'validation/request', 'validation/retry', 'evaluation/request', 'evaluation/retry', 'review/decide', 'adoption/apply', 'adoption/reconcile']);
