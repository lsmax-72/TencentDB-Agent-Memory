...
const ACTIONS = new Set(['overview', 'records/list', 'records/get', 'profiles/list', 'profiles/save', 'task/complete', 'diagnosis/request', 'diagnosis/retry', 'generation/retry', 'validation/request', 'validation/retry', 'review/decide']);
